      ...
      TenantSlugAvailabilityRequest: {
        ...
        properties: {
          slug: {
            type: "string",
            maxLength: 48,
            description: "Candidate tenant slug. The API trims and lowercases before validating availability."
          }
        }
      },
    ...
    "/api/v1/platform/tenant/slug-availability": {
      post: {
        ...
        responses: {
          ...
          "401": errorResponse("Unauthenticated request", "unauthenticated", "Missing bearer token"),
          "403": errorResponse("Role not allowed", "forbidden_role", "Insufficient role"),
          "429": errorResponse("Rate limited", "rate_limited", "Too many tenant directory requests")
        }
      }
    },
