...
test("tenant create shell advances through placeholder steps and protects entered progress on cancel", async ({ page }) => {
  await primeAuthenticatedSession(page, "super_admin");
...
test("tenant create shell allows clean cancel when no step data has been entered", async ({ page }) => {
  await primeAuthenticatedSession(page, "super_admin");
