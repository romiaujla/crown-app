...
const reasonCopy: Record<string, { title: string; description: string }> = {
  ...
  multiple_active_tenant_memberships: {
    ...
    description:
      'This session needs a deterministic tenant destination before Crown can enter a workspace.',
  },
  route_not_allowed: {
    title: 'This route is not available for your role',
    description:
      'Crown blocked the requested destination because it does not match your authenticated shell.',
  },
};
