...
const avatarVariants = cva(
  'relative inline-flex shrink-0 select-none items-center justify-center overflow-hidden rounded-full border border-border bg-muted/80 font-semibold uppercase text-foreground shadow-sm',
  {
    variants: {
      size: {
        sm: 'h-8 w-8 text-[0.72rem] tracking-[0.08em]',
        md: 'h-11 w-11 text-[0.9rem] tracking-[0.08em]',
