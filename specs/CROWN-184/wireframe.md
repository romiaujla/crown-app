...
- Mobile: optional single-line parent navigation fallback before the page title, rendered as `Back to parent` when a parent route exists and `showMobileBackLink` is enabled.
