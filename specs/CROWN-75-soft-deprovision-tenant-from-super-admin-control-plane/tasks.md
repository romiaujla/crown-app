...
- [ ] T009 [P] [US1] Add contract coverage for `POST /api/v1/platform/tenant/deprovision` with `tenant_id` in the request body in `/Users/ramanpreetaujla/Documents/AI-Projects/crown-app/apps/api/tests/contract/platform-tenant-soft-deprovision.contract.spec.ts`
...
Task: "Add contract coverage for POST /api/v1/platform/tenant/deprovision with tenant_id in apps/api/tests/contract/platform-tenant-soft-deprovision.contract.spec.ts"
